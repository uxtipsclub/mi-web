...
function App() {
  ...
  const experienceLabTrainings = [
    ...
    },
    {
      ...
      longDescription: 'Muchos equipos optimizan touchpoints individuales y pierden de vista la experiencia completa: soluciones que mejoran una parte del journey pero generan fricción en otra, o iniciativas de frontstage que chocan con un backstage que nadie ha diseñado.\n\nEn este workshop aprenderás los fundamentos del Service Design, conocerás sus herramientas principales y las aplicarás en un ejercicio práctico con casos reales. Saldrás con una base sólida y una primera experiencia real diseñando servicios de manera estratégica.',
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
                <div className="flex-shrink-0">
                  <a href="https://www.service-design-network.org/" target="_blank" rel="noopener noreferrer">
                    <img src="/partners/masthead.svg" alt="Service Design Network" className="h-10 w-auto" />
                  </a>
                </div>
                <div className="max-w-2xl">
                  <a href="https://www.service-design-network.org/" target="_blank" rel="noopener noreferrer" className="hover:text-purple-700 transition-colors">
