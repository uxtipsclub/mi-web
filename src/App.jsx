...
function App() {
  ...
  const experienceLabTrainings = [
    ...
    {
      id: 2,
      title: 'Introducción a Service Design',
      status: 'available',
      link: 'https://luma.com/a9v6k1zm',
      tools: 'Zoom & Miro',
      format: 'Online',
      language: 'Spanish',
      description: 'Aprende a diseñar servicios como sistemas integrales: lo que el usuario ve, lo que sucede detrás y cómo todo se conecta para crear una experiencia coherente.',
      longDescription: 'Muchos equipos se enfocan en optimizar pantallas, flujos o touchpoints individuales, pero pierden de vista la experiencia de extremo a extremo. El resultado: soluciones que mejoran una parte del journey, pero generan fricción en otra; o iniciativas de frontstage que chocan con un backstage que nadie ha diseñado.\n\nService Design te ofrece el marco para entender el servicio como un sistema integral: lo que el usuario ve, lo que sucede detrás y cómo todo se conecta para crear una experiencia coherente.\n\nEn este workshop aprenderás los fundamentos del Service Design, conocerás sus herramientas principales y las aplicarás en un ejercicio práctico. Además, explorarás casos reales de cómo organizaciones han integrado Service Design en sus equipos y procesos para impulsar la innovación y generar impacto. Saldrás no solo con una base teórica sólida, sino con una primera experiencia real diseñando servicios de manera estratégica.',
      date: '3 de Junio · 18:30 - 20:30 CEST',
      instructor: 'Eugenia Jongewaard',
