...
function App() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero */}
      <section className="relative pt-16 text-white min-h-screen flex flex-col overflow-hidden">
              ...
              <div className="mt-10 border-t border-gray-200 pt-8">
                ...
                <div className="flex gap-4">
                  ...
                  <a href="https://www.linkedin.com/in/eugeniajongewaard/" target="_blank" rel="noopener noreferrer"
                    className="w-12 h-12 border border-gray-200 flex items-center justify-center text-gray-400 hover:border-purple-700 hover:text-purple-700 transition-colors group"
                    aria-label="LinkedIn">
